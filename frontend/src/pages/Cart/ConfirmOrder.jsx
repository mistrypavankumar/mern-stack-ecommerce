...
const ConfirmOrder = () => {
  ...
  const proceedToPayment = () => {
    ...
    // session storage is same as localstorage but data will get destroy in sesssion storage after closeing the tab of a browser
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-5 my-3">
                    <div className="flex justify-between">
                      <p>Subtotal: </p>
                      <span className="text-slate-500">{`${rupeeSymbol}${subtotal}`}</span>
                    </div>
                    <div className="flex justify-between">
                      <p>Shipping Charges: </p>
                      <span className="text-slate-500">{`${rupeeSymbol}${shippingCharges}`}</span>
                    </div>
                    <div className="flex justify-between">
                      <p>GST: </p>
                      <span className="text-slate-500">{`${rupeeSymbol}${tax}`}</span>
                    </div>
                  </div>
